...
// *****************************************************************************************************************
  ...
  //movement(move_group, home[0], 0.29, 0.60, -1.1, 3.142, 6.5); //pose1
...
// movement(move_group, home[0], 0.29, 0.60, -1.1, 3.142, 6.5); //pose1
movement(move_group, -0.238807,0.643252, 0.33, 0, home[4], home[5]); //a1
movement(move_group, -0.238807,0.643252, 0.23, 0, home[4], home[5]); //a1
cin>>proceed;
movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
...
movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
ros::Duration(4).sleep();
movement(move_group, -0.369896,0.493138, 0.33, 00, 3.142, 7.10); //a2
movement(move_group, -0.369896,0.493138, 0.23, 00, 3.142, 7.10); //a2
cin>>proceed;
movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
...
movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
ros::Duration(4).sleep();
movement(move_group, -0.18,0.468464, 0.33, 00, 3.142, 7.10); //a7
movement(move_group, -0.18,0.468464, 0.23, 00, 3.142, 7.10); //a7
cin>>proceed;
movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
...
movement(move_group, 0.1,0.45, 0.35, 0, 3.142, 7.10);
movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
  //movement(move_group, 0, 0.20, 0.50, -1.25, 3.142, 6.5); //pose4 not reached
  ...
  //   // movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
  //   // movement(move_group, -0.238807,0.643252, 0.23, 00, 3.142, 7.10); //a1
  //   // cin.get(picking_done);
  //   //movement(move_group, home[0], home[1], home[2], home[3], home[4], home[5]);
  //   movement(move_group, home[0], 0.45, home[2], 0, 2.142, 7.5);
  //   // movement(move_group, -0.238807,0.643252, 0.23, 00, 3.142, 7.10); //a1
  //   //
  //   //
  //   //
  //   // movement(move_group, 0.25,0.45, 0.35, 0, 3.142, 7.10); //t5
  //   // movement(move_group, 0.25,0.45, 0.24, 0, 3.142, 7.10); //t5
  //   //
  //   //ovement(move_group, -0.238807,0.643252, 0.2-23, 00, 3.142, 7.10);
  //   // // movement(move_group, 0.25,0.45, 0.35, 0, 3.142, 7.10); //t5
  //   // // movement(move_group, 0.25,0.45, 0.24, 0, 3.142, 7.10); //t5
  //   // cin.get(picking_done);
  //
  //   // //Testing Area
  //   // movement(move_group, -0.238807,0.643252, 0.2-23, 00, 3.142, 7.10); //a1
  //   // movement(move_group, -0.369896,0.493138, 0.23, 00, 3.142, 7.10); //a2
  //   // movement(move_group, -0.198326,0.369083, 0.23, 00, 3.142, 7.10); //a3
  //   // movement(move_group, -0.5,0.278723, 0.23, 00, 3.142, 7.10); //a4
  //   // movement(move_group, -0.29,0.468857, 0.23, 00, 3.142, 7.10); //a5
  //   // movement(move_group, -0.29,0.7, 0.23, 00, 3.142, 7.10); //a6
  //   // movement(move_group, -0.18,0.468464, 0.23, 00, 3.142, 7.10); //a7
  //   // movement(move_group, -0.5,0.468464, 0.23, 00, 3.142, 7.10); //a8
  //   // movement(move_group, -0.35,0.31, 0.23, 00, 3.142, 7.10); //a9
  //   // cin.get(picking_done);
  //
  //
  //
  ...
  //   //   movement(move_group, transformedPointsPanda[0], transformedPointsPanda[1], 0.23, 0, 3.142, 7.2);//0.1
  //   //   cin.get(picking_done);
  //   //
  //   //   ros::Duration(3).sleep();
  //   //
  ...
  //   //   // %%%%%go to home position for drop location
  //   //   movement(move_group, 0.2,0.45, 0.35, 0, 3.142, 7.10);
  //   //   movement(move_group, 0.2,0.45, 0.23, 0, 3.142, 7.10);
  //   //
  //   //   ros::Duration(3).sleep();
  //   //
  //   //   cout<<"\n<";
  ...
  //
  //     //Fruit positions
  //     //movement(move_group, -0.238807,0.643252, 0.23, 00, 3.142, 7.10);
  //
  //
  //
  //   //}
