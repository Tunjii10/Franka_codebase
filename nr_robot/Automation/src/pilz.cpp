...
int main(int argc, char* argv[])
{
  ...
  for (int i = 1; i < 25; i++){
    ...
    if (enclosure == 1){
      ...
      // %%%%%% go to midpoint operation 2
      movement(move_group, 0.40, 0.1, 0.85, 2.79, 0.50, 2.4);
    } else if (enclosure == 5){
      // %%%%%% go to midpoint operation 1
    ...
    if (enclosure == 1){
      ...
      movement(move_group, 0.52, 0.35, 0.38, 0, 3.142, 5.60);
      ...
      // %%%%% go to place operation 2 - descent
      movement(move_group, 0.52,0.24, 0.38, 0, 3.142, 5.60);
      ...
      // %%%%% go to place operation 2 - descent
      movement(move_group, 0.50, 0.13, 0.38, 0, 3.142, 5.60);
      ...
      // %%%%% go to place operation 2 - descent
      movement(move_group, 0.50, 0.024, 0.38, 0, 3.142, 5.60);
      ...
      // %%%%% go to place operation 2 - descent
      movement(move_group, 0.49, -0.08, 0.38, 0, 3.142, 5.60);
      ...
      // %%%%% go to place operation 2 - descent
      movement(move_group, 0.49, -0.189, 0.38, 0, 3.142, 5.60);
      ...
      // %%%%% go to place operation 2 - descent
      movement(move_group, 0.49, -0.28, 0.38, 0, 3.142, 5.00);
      ...
      // %%%%% go to place operation 2 - descent
      movement(move_group, 0.49, -0.39, 0.38, 0, 3.142, 5.00);
    ...
    if (i%1 == 0){
      ...
      //   movement(move_group, 0.49, -0.39, 0.60, 0, 3.142, 5.00);
      //
      //   // %%%%% go to pick cut  operation 1 - descent
      //   movement(move_group, 0.49, -0.39, 0.31, 0, 3.142, 5.00);
      //   // publish line to  activate suction
      //   // pickup_pub.publish(msg);
      //   ros::Duration(3).sleep();// sleep for suction release
      //
      ...
      //   // publish line to  deactivate suction
      ...
      //
      //   // %%%%% go to pick cut  operation 1 - descent
      //   movement(move_group, 0.49, -0.28, 0.31, 0, 3.142, 5.00);
      //   // publish line to  activate suction
      //   // pickup_pub.publish(msg);
      //   ros::Duration(3).sleep();// sleep for suction release
      //
      ...
      //
      //   // %%%%% go to pick cut  operation 1 - descent
      //   movement(move_group, 0.49, -0.182, 0.31, 0, 3.142, 5.60);
      //
      //   // publish line to  activate suction
      //   string suction =  "";
      //   // pickup_pub.publish(msg);
      ...
      //
      //   // %%%%% go to pick cut  operation 1 - descent
      //   movement(move_group, 0.49, -0.079, 0.31, 0, 3.142, 5.60);
      //
      //   // publish line to  activate suction
      //   string suction =  "";
      //   // pickup_pub.publish(msg);
      ...
      //   movement(move_group, 0.50, 0.025, 0.31, 0, 3.142, 5.60);
      //   // publish line to  activate suction
      //   string suction =  "";
      //   // pickup_pub.publish(msg);
      //   ros::Duration(3).sleep();// sleep for suction release
      ...
      //
      //   // %%%%% go to pick cut  operation 2 - descent
      //   movement(move_group, 0.50, 0.14, 0.31, 0, 3.142, 5.60);
      //   // publish line to  activate suction
      //   // pickup_pub.publish(msg);
      //   ros::Duration(3).sleep();// sleep for suction release
      //
      ...
      //
      //   // %%%%% go to pick cut  operation 2 - descent
      //   movement(move_group, 0.50, 0.24, 0.28, 0, 3.142, 5.60);
      //   // publish line to  activate suction
      //   // pickup_pub.publish(msg);
      //   ros::Duration(3).sleep();// sleep for suction release
      //
      ...
      // }
      {
        ...
        //
        // // %%%%% go to pick cut  operation 2 - descent
        // movement(move_group,  0.526, 0.34, 0.29, 0, 3.142, 5.60);
        // // publish line to  activate suction
        // // pickup_pub.publish(msg);
        // ros::Duration(3).sleep();// sleep for suction release
        //
